...
const LeftPane = () => {
  return (
    <div className="flex-col items-start justify-center w-full space-y-5">
        <a href="/create-community" className="flex flex-row space-x-2 items-center justify-center text-white light:bg-gray-500 dark:bg-gray-900 py-2 px-3 rounded-full w-full">
