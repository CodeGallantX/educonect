    ...
    <div className="w-full p-4 rounded-lg bg-gray-900">
      <div className="flex items-start space-x-4">
        ...
        <div className="w-full">
          <textarea
            id="postBox"
            className={`w-full text-[12px] sm:text-sm md:text-base rounded-md pt-1.5 sm:py-2 px-4 text-gray-800 dark:text-gray-100 bg-gray-200 dark:bg-gray-800 border border-gray-500 focus:outline-none focus:ring-1 light:focus:ring-primary dark:focus:ring-gray-300 transition-all ${isFocused ? "h-32" : "h-12"
              }`}
