    ...
    return (
        <div className="min-h-screen md:hidden flex flex-col items-start justify-end space-y-8 light:bg-gray-200 dark:bg-gray-800">
            ...
            <div className="absolute bottom-6 z-20 flex flex-col items-start w-full justify-center space-y-2 p-6 pb-0">
                ...
                <p className="w-full text-sm text-white">Already have an account? <Link to="/login" className='font-bold underline transition duration-300 ease-in-out'>Log in</Link></p>
            </div>
            </div>
        </div>
    )
