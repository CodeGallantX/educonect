...
const LeftPane = () => {
  return (
    ...
    <a href="/community" className="flex flex-row space-x-2 items-center justify-center text-white bg-transparent border border-gray-500 py-2 px-3 rounded-full w-4/5 sm:w-full">
